...
class EgoPayFormSCI extends EgoPaySci {
     ...
     * @var string
     */
    protected $_imageUrl = "https://www.egopay.com/cdn/frontend/images/ego_88x31_o2.png";
    /**
     *
     * @var string
     */
    protected $_buttonName = "buy";
    ...
    public function createVerify($aData)
    {
        ...
        ksort($aData);
        $string = $this->_storePassword . '|' . implode('|', $aData);
    ...
    public function getFormHtml($aData)
    {
        ...
        $html = sprintf('<form method="post" action="%s">', $this->_paymentUrl) . " \n";
        ...
        $html .= sprintf('<input class="egopay-%1$s" type="image" name="%1$s" src="%2$s" alt="%3$s EgoPay" />',
                    $this->_buttonName, $this->_imageUrl, ucfirst($this->_buttonName)) . " \n";
        $html .= '</form>' . " \n";
        return $html;
    }
}
...
class EgoPaySubscription extends EgoPayFormSCI {
     ...
     * @var string
     */
    protected $_buttonName = "subscribe";
